    ...
    <section id="home" className="min-h-screen flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <img src="/placeholder.svg?height=100&width=100" alt="Image 1" className="w-24 h-24 rounded-full" />
          <img src="/placeholder.svg?height=100&width=100" alt="Image 2" className="w-24 h-24 rounded-full" />
        </div>
