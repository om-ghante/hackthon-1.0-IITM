...
import TeamImage from "../assets/imageteam.png";
...
const Team = () => {
  const teamMembers = [
    { name: "John Doe", role: "Organizer", image: TeamImage },
    { name: "Jane Smith", role: "Tech Lead", image: TeamImage },
    { name: "Mike Johnson", role: "Designer", image: TeamImage },
    { name: "Emily Brown", role: "Marketing", image: TeamImage },
  ]
